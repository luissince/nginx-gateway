...
certbot --nginx --keep-until-expiring -m alexander_dx_10@hotmail.com --agree-tos -d api.syssoftintegra.com --redirect --no-eff-email
...
# certbot --nginx --keep-until-expiring -m alexander_dx_10@hotmail.com --agree-tos -d inmobiliariagmyc.com -d www.inmobiliariagmyc.com --redirect --no-eff-email

# certbot --nginx --keep-until-expiring -m alexander_dx_10@hotmail.com --agree-tos -d sunat.inmobiliariagmyc.com --redirect --no-eff-email

# certbot --nginx --keep-until-expiring -m alexander_dx_10@hotmail.com --agree-tos -d app.leatsac.com --redirect --no-eff-email
